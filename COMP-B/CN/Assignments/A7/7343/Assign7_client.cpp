...
int main()
{
	...
	while(true)
	{
		...
		if((rMsgSize = recvfrom(clientId, receiveMessage , MAX , 0 , (struct sockaddr*) &serverAddr , (socklen_t*) &len)) >= 0)
		{ // receiving the binary cahracters
