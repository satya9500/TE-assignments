...
class Pass1 {
	...
	public static void printTableWithIC(Vector<String[]> table){
		System.out.println(String.format("%s  |  %s  |  %s  |  %s  |  %s  |  %s  |  %s", center("LABEL", 15), center("OPCODE", 15), center("OPERANDS", 15), center("LC", 10), center("CODE", 15), center("REGISTER", 10), center("OPERAND_TYPE", 15)));
		System.out.println("--------------------------------------------------------------------------------------------------------------------");	
		...
		for(int i = 0 ; i < n ; i++){
			...
			System.out.println(String.format("%-15s  |  %-15s  |  %-15s  |  %-10s  |  %-15s  |  %-10s  |  %-15s", table.get(i)[0], table.get(i)[1], table.get(i)[2], lcResult, codeResult, registerResult, operandResult));
			System.out.println("--------------------------------------------------------------------------------------------------------------------");
		}
